...
static const _LocalizeInMap_Request_type_support_symbol_names_t _LocalizeInMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros_visual_slam_interfaces, srv, LocalizeInMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros_visual_slam_interfaces, srv, LocalizeInMap_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isaac_ros_visual_slam_interfaces, srv, LocalizeInMap_Request)() {
  return &::isaac_ros_visual_slam_interfaces::srv::rosidl_typesupport_c::LocalizeInMap_Request_message_type_support_handle;
}
...
static const _LocalizeInMap_Response_type_support_symbol_names_t _LocalizeInMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros_visual_slam_interfaces, srv, LocalizeInMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros_visual_slam_interfaces, srv, LocalizeInMap_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isaac_ros_visual_slam_interfaces, srv, LocalizeInMap_Response)() {
  return &::isaac_ros_visual_slam_interfaces::srv::rosidl_typesupport_c::LocalizeInMap_Response_message_type_support_handle;
}
...
static const _LocalizeInMap_type_support_symbol_names_t _LocalizeInMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros_visual_slam_interfaces, srv, LocalizeInMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaac_ros_visual_slam_interfaces, srv, LocalizeInMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, isaac_ros_visual_slam_interfaces, srv, LocalizeInMap)() {
  return &::isaac_ros_visual_slam_interfaces::srv::rosidl_typesupport_c::LocalizeInMap_service_type_support_handle;
}
