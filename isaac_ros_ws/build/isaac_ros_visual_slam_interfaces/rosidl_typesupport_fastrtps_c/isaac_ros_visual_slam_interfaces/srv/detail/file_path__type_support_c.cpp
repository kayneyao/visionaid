...
#include "isaac_ros_visual_slam_interfaces/srv/detail/file_path__rosidl_typesupport_fastrtps_c.h"
...
using _FilePath_Request__ros_msg_type = isaac_ros_visual_slam_interfaces__srv__FilePath_Request;
...
size_t get_serialized_size_isaac_ros_visual_slam_interfaces__srv__FilePath_Request(
  const void * untyped_ros_message,
...
static uint32_t _FilePath_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_isaac_ros_visual_slam_interfaces__srv__FilePath_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros_visual_slam_interfaces
size_t max_serialized_size_isaac_ros_visual_slam_interfaces__srv__FilePath_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isaac_ros_visual_slam_interfaces__srv__FilePath_Request;
    is_plain =
      (
...
static size_t _FilePath_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_isaac_ros_visual_slam_interfaces__srv__FilePath_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros_visual_slam_interfaces, srv, FilePath_Request)() {
...
using _FilePath_Response__ros_msg_type = isaac_ros_visual_slam_interfaces__srv__FilePath_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros_visual_slam_interfaces
size_t get_serialized_size_isaac_ros_visual_slam_interfaces__srv__FilePath_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FilePath_Response__ros_msg_type * ros_message = static_cast<const _FilePath_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_isaac_ros_visual_slam_interfaces__srv__FilePath_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros_visual_slam_interfaces
size_t max_serialized_size_isaac_ros_visual_slam_interfaces__srv__FilePath_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = isaac_ros_visual_slam_interfaces__srv__FilePath_Response;
    is_plain =
      (
...
static size_t _FilePath_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_isaac_ros_visual_slam_interfaces__srv__FilePath_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros_visual_slam_interfaces, srv, FilePath_Response)() {
...
// already included above
// #include "isaac_ros_visual_slam_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "isaac_ros_visual_slam_interfaces/srv/file_path.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros_visual_slam_interfaces, srv, FilePath)() {
