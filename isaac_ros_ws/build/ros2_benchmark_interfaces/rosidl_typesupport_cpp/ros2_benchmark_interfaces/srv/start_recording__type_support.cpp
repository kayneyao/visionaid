...
static const _StartRecording_Request_type_support_symbol_names_t _StartRecording_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, srv, StartRecording_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_benchmark_interfaces, srv, StartRecording_Request)),
  }
};
...
{
  return &::ros2_benchmark_interfaces::srv::rosidl_typesupport_cpp::StartRecording_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_benchmark_interfaces, srv, StartRecording_Request)() {
  return get_message_type_support_handle<ros2_benchmark_interfaces::srv::StartRecording_Request>();
}
...
static const _StartRecording_Response_type_support_symbol_names_t _StartRecording_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, srv, StartRecording_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_benchmark_interfaces, srv, StartRecording_Response)),
  }
};
...
{
  return &::ros2_benchmark_interfaces::srv::rosidl_typesupport_cpp::StartRecording_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_benchmark_interfaces, srv, StartRecording_Response)() {
  return get_message_type_support_handle<ros2_benchmark_interfaces::srv::StartRecording_Response>();
}
...
static const _StartRecording_type_support_symbol_names_t _StartRecording_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, srv, StartRecording)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_benchmark_interfaces, srv, StartRecording)),
  }
};
...
{
  return &::ros2_benchmark_interfaces::srv::rosidl_typesupport_cpp::StartRecording_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_benchmark_interfaces, srv, StartRecording)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ros2_benchmark_interfaces::srv::StartRecording>();
}
