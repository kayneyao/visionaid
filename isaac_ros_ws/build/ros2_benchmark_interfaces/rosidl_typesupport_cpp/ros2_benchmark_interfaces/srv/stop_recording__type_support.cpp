...
static const _StopRecording_Request_type_support_symbol_names_t _StopRecording_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, srv, StopRecording_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_benchmark_interfaces, srv, StopRecording_Request)),
  }
};
...
{
  return &::ros2_benchmark_interfaces::srv::rosidl_typesupport_cpp::StopRecording_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_benchmark_interfaces, srv, StopRecording_Request)() {
  return get_message_type_support_handle<ros2_benchmark_interfaces::srv::StopRecording_Request>();
}
...
static const _StopRecording_Response_type_support_symbol_names_t _StopRecording_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, srv, StopRecording_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_benchmark_interfaces, srv, StopRecording_Response)),
  }
};
...
{
  return &::ros2_benchmark_interfaces::srv::rosidl_typesupport_cpp::StopRecording_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_benchmark_interfaces, srv, StopRecording_Response)() {
  return get_message_type_support_handle<ros2_benchmark_interfaces::srv::StopRecording_Response>();
}
...
static const _StopRecording_type_support_symbol_names_t _StopRecording_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, srv, StopRecording)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_benchmark_interfaces, srv, StopRecording)),
  }
};
...
{
  return &::ros2_benchmark_interfaces::srv::rosidl_typesupport_cpp::StopRecording_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_benchmark_interfaces, srv, StopRecording)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ros2_benchmark_interfaces::srv::StopRecording>();
}
