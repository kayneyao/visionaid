...
static const _TopicMessageTimestampArray_type_support_symbol_names_t _TopicMessageTimestampArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, msg, TopicMessageTimestampArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_benchmark_interfaces, msg, TopicMessageTimestampArray)),
  }
};
...
{
  return &::ros2_benchmark_interfaces::msg::rosidl_typesupport_cpp::TopicMessageTimestampArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_benchmark_interfaces, msg, TopicMessageTimestampArray)() {
  return get_message_type_support_handle<ros2_benchmark_interfaces::msg::TopicMessageTimestampArray>();
}
