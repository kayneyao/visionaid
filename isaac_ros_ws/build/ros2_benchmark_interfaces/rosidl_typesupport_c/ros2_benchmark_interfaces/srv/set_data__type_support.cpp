...
static const _SetData_Request_type_support_symbol_names_t _SetData_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_benchmark_interfaces, srv, SetData_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_benchmark_interfaces, srv, SetData_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_benchmark_interfaces, srv, SetData_Request)() {
  return &::ros2_benchmark_interfaces::srv::rosidl_typesupport_c::SetData_Request_message_type_support_handle;
}
...
static const _SetData_Response_type_support_symbol_names_t _SetData_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_benchmark_interfaces, srv, SetData_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_benchmark_interfaces, srv, SetData_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_benchmark_interfaces, srv, SetData_Response)() {
  return &::ros2_benchmark_interfaces::srv::rosidl_typesupport_c::SetData_Response_message_type_support_handle;
}
...
static const _SetData_type_support_symbol_names_t _SetData_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_benchmark_interfaces, srv, SetData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_benchmark_interfaces, srv, SetData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros2_benchmark_interfaces, srv, SetData)() {
  return &::ros2_benchmark_interfaces::srv::rosidl_typesupport_c::SetData_service_type_support_handle;
}
