...
#ifndef ROS2_BENCHMARK_INTERFACES__SRV__DETAIL__SET_DATA__FUNCTIONS_H_
#define ROS2_BENCHMARK_INTERFACES__SRV__DETAIL__SET_DATA__FUNCTIONS_H_
...
/// Initialize srv/SetData message.
/**
...
/// Create srv/SetData message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_benchmark_interfaces__srv__SetData_Request__init().
...
/// Destroy srv/SetData message.
/**
 * It calls
 * ros2_benchmark_interfaces__srv__SetData_Request__fini()
...
/// Check for srv/SetData message equality.
/**
...
/// Initialize array of srv/SetData messages.
/**
...
/// Finalize array of srv/SetData messages.
/**
 * It calls
 * ros2_benchmark_interfaces__srv__SetData_Request__fini()
...
/// Create array of srv/SetData messages.
/**
 * It allocates the memory for the array and calls
 * ros2_benchmark_interfaces__srv__SetData_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetData messages.
/**
 * It calls
 * ros2_benchmark_interfaces__srv__SetData_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetData message array equality.
/**
...
/// Copy an array of srv/SetData messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_benchmark_interfaces__srv__SetData_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_benchmark_interfaces
...
/**
 * It calls
 * ros2_benchmark_interfaces__srv__SetData_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_benchmark_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ros2_benchmark_interfaces__srv__SetData_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_benchmark_interfaces
...
/**
 * It calls
 * ros2_benchmark_interfaces__srv__SetData_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS2_BENCHMARK_INTERFACES__SRV__DETAIL__SET_DATA__FUNCTIONS_H_
