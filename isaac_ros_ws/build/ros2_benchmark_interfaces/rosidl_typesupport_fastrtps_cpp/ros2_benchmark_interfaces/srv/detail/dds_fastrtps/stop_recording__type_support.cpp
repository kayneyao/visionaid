...
#include "ros2_benchmark_interfaces/srv/detail/stop_recording__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_benchmark_interfaces::srv::StopRecording_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_benchmark_interfaces::srv::StopRecording_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_benchmark_interfaces::srv::StopRecording_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_benchmark_interfaces::srv::StopRecording_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_benchmark_interfaces::srv::StopRecording_Request *>(
    untyped_ros_message);
...
{
  return &ros2_benchmark_interfaces::srv::typesupport_fastrtps_cpp::_StopRecording_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, srv, StopRecording_Request)() {
  return &ros2_benchmark_interfaces::srv::typesupport_fastrtps_cpp::_StopRecording_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_benchmark_interfaces
cdr_serialize(
  const ros2_benchmark_interfaces::srv::StopRecording_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: structure_needs_at_least_one_member
  cdr << ros_message.structure_needs_at_least_one_member;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_benchmark_interfaces::srv::StopRecording_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_benchmark_interfaces::srv::StopRecording_Response;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const ros2_benchmark_interfaces::srv::StopRecording_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_benchmark_interfaces::srv::StopRecording_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_benchmark_interfaces::srv::typesupport_fastrtps_cpp::_StopRecording_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, srv, StopRecording_Response)() {
  return &ros2_benchmark_interfaces::srv::typesupport_fastrtps_cpp::_StopRecording_Response__handle;
}
...
{
  return &ros2_benchmark_interfaces::srv::typesupport_fastrtps_cpp::_StopRecording__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_benchmark_interfaces, srv, StopRecording)() {
  return &ros2_benchmark_interfaces::srv::typesupport_fastrtps_cpp::_StopRecording__handle;
}
