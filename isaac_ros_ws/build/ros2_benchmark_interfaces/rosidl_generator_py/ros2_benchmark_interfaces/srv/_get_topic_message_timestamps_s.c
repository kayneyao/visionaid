...
bool ros2_benchmark_interfaces__srv__get_topic_message_timestamps__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_benchmark_interfaces.srv._get_topic_message_timestamps.GetTopicMessageTimestamps_Request", full_classname_dest, 93) == 0);
  }
  ros2_benchmark_interfaces__srv__GetTopicMessageTimestamps_Request * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of GetTopicMessageTimestamps_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_benchmark_interfaces.srv._get_topic_message_timestamps");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetTopicMessageTimestamps_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool ros2_benchmark_interfaces__srv__get_topic_message_timestamps__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_benchmark_interfaces.srv._get_topic_message_timestamps.GetTopicMessageTimestamps_Response", full_classname_dest, 94) == 0);
  }
  ros2_benchmark_interfaces__srv__GetTopicMessageTimestamps_Response * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of GetTopicMessageTimestamps_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_benchmark_interfaces.srv._get_topic_message_timestamps");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetTopicMessageTimestamps_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
