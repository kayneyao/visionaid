...
def generate_launch_description():
    ...
    model_path_arg = DeclareLaunchArgument(
        'model_path',
        default_value='/home/sophie/visionaid/isaac_ros_ws/models/yolov8_bdd100k/best.trt',
        description='Path to YOLOv8 TensorRT model'
    )
    ...
    # Package paths
    yolov8_package = FindPackageShare('yolov8_bdd100k_detection')
