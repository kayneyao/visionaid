...
local_parameters = [{'name': 'camera_name',                  'default': 'camera',      'description': 'camera unique name'},
                    ...
                    {'name': 'rgb_camera.enable_auto_exposure',  'default': 'false', 'description': 'enable depth auto exposure'},
                    {'name': 'rgb_camera.auto_exposure_priority',  'default': 'false', 'description': 'enable depth auto exposure'},
                    {'name': 'depth_module.enable_auto_exposure',  'default': 'false', 'description': 'enable depth auto exposure'},
