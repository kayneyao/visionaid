...
def monitor_training_progress():
    ...
    try:
        ...
        print(f"⏱️  Total Training Time: {latest['time']:.1f} seconds ({latest['time']/3600:.2f} hours)")
        print()
        ...
        print("📉 LOSS METRICS:")
        print(f"  🏋️  Train Loss: {latest['train/box_loss']:.4f} (box) + {latest['train/cls_loss']:.4f} (cls) + {latest['train/dfl_loss']:.4f} (dfl)")
