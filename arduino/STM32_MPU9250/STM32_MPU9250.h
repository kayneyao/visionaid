#ifndef _STM32_MPU9250_H_
#define _STM32_MPU9250_H_

#include <Wire.h>

#define SERIAL_DEBUG true

// Magnetometer Registers - https://www.haoyuelectronics.com/Attachment/GY-9250/RM-MPU-9250A-00.pdf
...
public: // temporary
    ...
    uint32_t _interfaceSpeed; // Stores the desired I2C clock rate
...
public:
    ...
    STM32_MPU9250(uint8_t address = MPU9250_ADDRESS_AD0, TwoWire &wirePort = Wire, uint32_t clock_frequency = 100000);
    void getMres();
    void getGres();
    void getAres();
