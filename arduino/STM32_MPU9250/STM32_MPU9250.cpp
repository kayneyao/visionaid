...
STM32_MPU9250::STM32_MPU9250(uint8_t address, TwoWire &wirePort, uint32_t clock_frequency)
{
    _I2Caddr = address;
    _wire = &wirePort;
...
void STM32_MPU9250::readAccelData(int16_t *destination)
{
...
void STM32_MPU9250::readGyroData(int16_t *destination)
{
...
void STM32_MPU9250::readMagData(int16_t *destination)
{
...
int16_t STM32_MPU9250::readTempData()
{
...
void STM32_MPU9250::initAK8963(float *destination)
{
...
void STM32_MPU9250::initMPU9250()
{
    // wake up device
...
void STM32_MPU9250::calibrateMPU9250(float *gyroBias, float *accelBias)
{
...
// deviation is a pass.
void STM32_MPU9250::MPU9250SelfTest(float *destination)
{
...
void STM32_MPU9250::magCalMPU9250(float *bias_dest, float *scale_dest)
{
...
uint8_t STM32_MPU9250::writeByte(uint8_t deviceAddress, uint8_t registerAddress,
                                 uint8_t data)
{
    return writeByteWire(deviceAddress, registerAddress, data);
}

uint8_t STM32_MPU9250::writeByteWire(uint8_t deviceAddress, uint8_t registerAddress,
                                     uint8_t data)
{
...
uint8_t STM32_MPU9250::readByte(uint8_t deviceAddress, uint8_t registerAddress)
{
    return readByteWire(deviceAddress, registerAddress);
}

// Read a byte from the given register address from device using I2C
uint8_t STM32_MPU9250::readByteWire(uint8_t deviceAddress, uint8_t registerAddress)
{
...
uint8_t STM32_MPU9250::readBytesWire(uint8_t deviceAddress, uint8_t registerAddress,
...
uint8_t STM32_MPU9250::readBytes(uint8_t deviceAddress, uint8_t registerAddress,
                                 uint8_t count, uint8_t *dest)
{
...
void STM32_MPU9250::kickHardware()
{
